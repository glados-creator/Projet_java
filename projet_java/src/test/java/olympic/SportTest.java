...
public class SportTest extends TestCase {
    ...
    public void setUp() {
        ...
        internal = new sport_type_generic(JO, "test_nom", Test_uniter, Test_Coef_Force, Test_Coef_Agilite,
                Test_Coef_Endurance, false);
    }

    @Test
    public void test_ToString() {
        assertEquals(internal.toString(),
                "{ Nom='test_nom', Uniter='test_uniter', Plus_haut_score='false', LesEpreuves='[]', Coef_Force='0.3333333333333333', Coef_Agilite='0.3333333333333333', Coef_Endurance='0.3333333333333333'}");
    }
