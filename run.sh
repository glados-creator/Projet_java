...
# java -ea -cp bin:bin/olympic/:bin/olympic/model/:bin/olympic/graphic:bin/olympic/graphic/GUI_admin:bin/olympic/graphic/GUI_organistateur:bin/olympic/graphic/GUI_presentateur:/usr/share/java/mariadb-java-client.jar --module-path /usr/share/openjfx/lib/ --add-modules javafx.controls olympic.JDBC.CsvToDatabase
